...
1. Download ahud by clicking `Download ZIP` from the green `Code` button on the ahud GitHub repo or by clicking [this link](https://github.com/n0kk/ahud/archive/refs/heads/master.zip).
